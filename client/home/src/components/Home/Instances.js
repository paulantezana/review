        ...
        <div className="Container">
            <div className="Instances-header">
                ...
                <div className="Instances-header-right">
                    <h2 className="Instances-title">Instancias</h2>
                    <p>Cada una de las instancias es una aplicación separada que se comunican con un api REST FULL centralizada.</p>
                </div>
            </div>

            <div className="Instances-content Grid s-2 m-3 l-4 lg-5">
                {
